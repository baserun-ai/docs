...
<Accordion title="completion_or_client.tag(key: str, value: str, metadata: Dict, tag_type: str): Tag">
...
<Accordion title="completion_or_client.log(message: str, name: Optional[string] = None, metadata: Optional[Dict] = None): Tag">
    <ResponseField type="Tag" name="tag" />
    <br />
...
<Accordion title="completion_or_client.variable(key: str, value: str, metadata: Optional[Dict] = None): Tag">
    <ResponseField type="Tag" name="tag" />
    <br />
    <ParamField path="key" type="string" required />
...
<Accordion title="completion_or_client.feedback(name: str, score: float, metadata: Optional[Dict] = None): Tag">
    <ResponseField type="Tag" name="tag" />
    <br />
    <ParamField path="name" type="string">An optional name that will show up in the trace detail view in the UI</ParamField>
...
<Accordion title="log(message: str, name: Optional[str] = None, metadata: Optional[Dict] = None): Tag">
    <ResponseField type="Tag" name="tag" />
    <br />
    <ParamField path="message" type="string" required />
    <ParamField path="name" type="string">An optional name that will show up in the trace detail view in the UI</ParamField>
