...
<ParamField
  ...
  required
></ParamField>
<ParamField path="metadata" type="object"></ParamField>
...
Within the LLM request or a trace, after create an client
...
After a trace or completion, you may want to add extra tags based on feedback collected later. To do this, store the <code>trace_id</code> and, for completions, the <code>completion_id</code>. Use the <code>tag</code>, <code>log</code>, or <code>feedback</code> functions to add tags, specifying trace_id and completion_id as needed.
