...
<Accordion title="client.chat.completions.create(name: Optional[str], user: Optional[str], session: Optional[str], metadata: optional[Dict]): Completion">
...
<Accordion title="completion.tag(key: str, value: str, metadata: Dict, tag_type: str): Tag">
...
<Accordion title="completion.log(message: str, name: Optional[str] = None, metadata: Optional[Dict] = None): Tag">
...
<Accordion title="completion.variable(key: str, value: str, metadata: Optional[Dict] = None): Tag">
    <ParamField path="key" type="string" required />
...
<Accordion title="completion.feedback(name: str, score: float, metadata: Optional[Dict] = None): Tag">
    <ParamField path="name" type="string">An optional name that will show up in the trace detail view in the UI</ParamField>
...
<Accordion title="log(message: string, name: Optional[str] = None, metadata: Optional[Dict] = None): Tag">
    <ParamField path="message" type="string" required />
    <ParamField path="name" type="string">An optional name that will show up in the trace detail view in the UI</ParamField>
    <ParamField path="metadata" type="object" />
    **Returns**
...
<Accordion title="variable(key: str, value: str, metadata: Optional[Dict] = None): Tag">
    <ParamField path="key" type="string" required />
    <ParamField path="value" type="string" required />
    <ParamField path="metadata" type="object" />
    **Returns**
...
<Accordion title="feedback(name: str, score: float, metadata: Optional[Dict] = None): Tag">
    <ParamField path="name" type="string">An optional name that will show up in the trace detail view in the UI</ParamField>
    <ParamField path="score" type="float" required >A score between 0 and 1</ParamField>
    <ParamField path="metadata" type="object" />
    **Returns**
...
<Accordion title="OpenAI(name: str, **kwargs): OpenAI">
...
<Accordion title="client.tag(key: str, value: str, metadata: Dict, tag_type: str): Tag">
    <ParamField path="key" type="string" required />
    <ParamField path="value" type="string/numeric/boolean/object/array" required />
    <ParamField path="metadata" type="object" />
    <ParamField path="tag_type" type="string">
...
<Accordion title="client.log(message: str, name: Optional[str] = None, metadata: Optional[Dict] = None): Tag">
    <ParamField path="message" type="string" required />
    <ParamField path="name" type="string">An optional name that will show up in the trace detail view in the UI</ParamField>
    <ParamField path="metadata" type="object" />
    **Returns**
...
<Accordion title="client.variable(key: str, value: str, metadata: Optional[Dict] = None): Tag">
    <ParamField path="key" type="string" required />
    <ParamField path="value" type="string" required />
    <ParamField path="metadata" type="object" />
    **Returns**
