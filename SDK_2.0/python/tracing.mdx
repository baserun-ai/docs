...
<ParamField path="tag" type="Tag Object">
  ...
  Learn more about [Tags](/SDK_2.0/python/tags)
</ParamField>
...
```
### Supported Models
At the moment, the Baserun Python SDK 2.0 supports all models using OpenAI library and Anthropic models, regardless of the provider. We are continuously adding support for new models. If you have a specific model you would like to use, please reach out to us at [hello@baserun.ai](mailto:hello@baserun.ai) or [join our community](https://discord.gg/EtR7NFQ4).
