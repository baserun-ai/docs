...
<Frame>![Online Evaluation](/images/annotating-overview.png)</Frame>

Online evaluation are evaluations which are triggered in the Baserun user interface. No code is required to create or run these evaluations, they happen completely within Baserun.

## Components of an Online Evaluation
...
<Frame>![Select Evaluators](/images/create-evaluation-select-evaluators.png)</Frame>
