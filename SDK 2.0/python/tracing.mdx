...
<ParamField path="log, user feedback, input variables" type="Tag Object">
...
<ParamField path="result" type="JSON Object">
...
<ParamField path="custom log, user feedback, input variables" type="Tag Object">
  All these objects are pre-defined tags. <br />
  Learn more about [Tags](../python/tags.mdx)
</ParamField>
...
Alternatively, you can also associate two events with the same trace or resume a trace using the trace_id. A common use case is when you want to add user feedback to a trace after the pipeline finishes executing.
...
a tag.
<ParamField path="key" type="string" optional></ParamField>
<ParamField
  path="value"
